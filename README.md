...
<div align="center">
  <img src="https://github.com/Legendarymaster0/Dotfiles.win/blob/Core/Config/Wallpaper/hyprlock.png" width="100%" style="border-radius: 8px; border: 1px solid #313244; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
</div>
